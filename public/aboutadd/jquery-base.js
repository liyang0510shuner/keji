...
if(system.win){
	document.write('<link href="__ROOT__/aboutadd/font_win.css" rel="stylesheet" type="text/css" />');
}else if(system.mac){
	document.write('<link href="__ROOT__/aboutadd/font_mac.css" rel="stylesheet" type="text/css" />');
}else if(system.xll){
	document.write('<link href="__ROOT__/aboutadd/font_xll.css" rel="stylesheet" type="text/css" />');
}
