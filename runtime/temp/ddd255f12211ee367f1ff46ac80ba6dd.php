<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"H:\phpStudy\WWW\month12\tp5\public/../application/index\view\people\my_info.html";i:1526475844;}*/ ?>
...
<!-- Bootstrap -->
<link href="/static/css/my_info.css" rel="stylesheet">
  ...
  <table class="my_info_content_care_table">
    <tbody>
      ...
      <tr>
        ...
        <td class="color555"><span class="color959595 margin_left10 font_size12">友情提示：网站不会显示您的身份信息，在有限合伙企业设立时会用到您的身份信息</span></td>
      </tr>
      <tr>
        <td align="right" class="color555">个人名片：</td>
        <td class="color555"><img id="cardimg" width="215" height="110" src="../img/member_center/carddefault.jpg"></img>
      ...
      <tr>
        <td align="right" class="color555">投资额度：</td>
        <td class="color555">最小投资金额
          <select name="">
            <option value="0">请选择</option>
          ...
          <span class="color959595 margin_left10 font_size12">请您如实填写</span><span class="colorCA1E37 margin_left10 font_size12">友好提示:投资有风险,入股需谨慎!</span></td>
      </tr>
      <tr>
